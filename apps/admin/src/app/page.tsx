...
import { Users, Building2, CheckCircle, AlertTriangle, TrendingUp, DollarSign } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Manage Cozumel marketplace businesses and verifications</p>
      </div>
