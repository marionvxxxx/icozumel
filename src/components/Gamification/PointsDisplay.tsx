    ...
    <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-sm text-gray-600">Keep exploring to earn more points!</p>
        </div>
          ...
          <div className="space-y-2">
            {recentEarnings.slice(0, 3).map((earning, index) => (
              <div key={index} className="flex items-center justify-between text-sm">
                <span className="text-gray-700">{earning.action}</span>
      ...
      <div className="mt-4 pt-4 border-t border-gray-100">
        <div className="grid grid-cols-3 gap-2">
          <button className="flex flex-col items-center p-2 bg-primary-50 text-primary-600 rounded-lg hover:bg-primary-100 transition-colors">
            <Star size={16} className="mb-1" />
            <span className="text-xs font-medium">Review</span>
            <span className="text-xs text-primary-500">+10 pts</span>
          </button>
          <button className="flex flex-col items-center p-2 bg-secondary-50 text-secondary-600 rounded-lg hover:bg-secondary-100 transition-colors">
            <Gift size={16} className="mb-1" />
            <span className="text-xs font-medium">Check-in</span>
            <span className="text-xs text-secondary-500">+5 pts</span>
          </button>
          <button className="flex flex-col items-center p-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition-colors">
